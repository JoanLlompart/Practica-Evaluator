...
public class EvaluatorTest {
    ...
    public void tests_rpn() {
        ...
        tokens = Token.getTokens("8 5 + 7 2 ^ - 98 - 2 1 - 5 2 - ^ -");
        //assertEquals(-35, Evaluator.calcRPN(tokens));
    ...
    public void tests_potencia() {
        ...
        */
        assertEquals(-135, Evaluator.calculate("8+5-7^2-98-(2-1)^(5-2)")); //falla a el token 11 o 12 que hi ha dos negatius.El problema mirar si es a token.
